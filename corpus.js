...
(() => {
  ...
  const CORPUS_BASE = [
    // --- Fonetica general -------------------------------------------------
    "El col·legi de Girona organitza una xerrada sobre intel·ligencia artificial.",
    ...
    "Els nens juguen a la platja mentre els pares prenen cafe a la terrassa.",
    ...
    "La Merce i el Jordi han quedat per esmorzar al bar de la cantonada.",
    "Vint-i-tres persones s'han apuntat al taller de fotografia digital.",
    "Aquell restaurant de Palafrugell fa un arros de peix excel·lent.",
    "El metge m'ha dit que he de fer mes exercici i menjar menys sucre.",
    ...
    "Quaranta-cinc mil dos-cents euros es una xifra que cal comprovar.",
    "La setmana que ve tanquem per vacances del dilluns al divendres.",

    // --- Girofeeds --------------------------------------------------------
    "Girofeeds genera els catalegs de producte per a Google Ads i per a Meta.",
    "Aquest mati he desplegat una versio nova de Girofeeds sense cap error.",
    ...
    // --- Feeds i catalegs -------------------------------------------------
    "He actualitzat el feed de productes del Merchant Center aquest mati.",
    "El feed complementari s'ha de pujar cada nit de manera automatica.",
    "Hem de comprovar per que el feed principal torna tants productes rebutjats.",
    "El cataleg en XML pesa mes de cent megues i triga molt a processar-se.",
    "Al cataleg hi ha productes sense codi de barres ni marca declarada.",
    "Puja el cataleg complet al Merchant Center abans de dos quarts de nou.",
    "El Merchant Center ens ha marcat quaranta articles com a no aptes.",

    // --- Google Ads i campanyes -------------------------------------------
    "La campanya de cerca ha gastat gairebe tot el pressupost diari.",
    ...
    "El pressupost d'aquest trimestre encara no esta aprovat pel client.",
    "La conversio de la campanya ha baixat respecte del mes passat.",
    "Necessito el pressupost i la previsio de Google Ads per dilluns.",

    // --- Gestio del dia a dia ---------------------------------------------
    "La targeta del Trello esta assignada i espera una revisio tecnica.",
    "Mou la targeta del Trello a la columna de fet quan acabis la feina.",
    "He obert una targeta al Trello per no perdre aquesta incidencia.",
    ...
    "Falta la factura del proveidor per tancar la comptabilitat del mes.",
    "Passa'm el numero de comanda i miro l'estat de l'enviament.",
    ...
    "Escriu-li per WhatsApp que la reunio es trasllada a les quatre.",
    ...
    "Cal enviar la proposta per correu electronic abans de dilluns al mati.",
    "Aquesta extensio de Chrome escriu directament al camp de text actiu."
  ];
